...
public class PokerHand {
	...
	public String toString() {
		return "%d. %-16s Rank:%d %-40s Best:%-7s Worst:-%6s :%s".formatted(playerNo, score, score.ordinal(), hand,Collections.max(hand, Comparator.comparing(Card::rank)),Collections.min(hand, Comparator.comparing(Card::rank)), (discards.size() > 0) ? "Disacrds: "+ discards : "");
	}
